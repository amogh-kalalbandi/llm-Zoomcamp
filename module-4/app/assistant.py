...
hugging_client = InferenceClient("HuggingFaceH4/zephyr-7b-beta", token=HF_API_TOKEN)
print(f'Hugging client initialized = {hugging_client}')
...
def llm(prompt, model_choice):
    ...
    if model_choice.startswith('ollama/'):
        ...
        messages = [{"role": "user", "content": prompt}]
        response = hugging_client.chat_completion(messages, max_tokens=1000)
...
def evaluate_relevance(question, answer):
    ...
    evaluation, tokens, _ = llm(prompt, 'HuggingFaceH4/zephyr-7b-beta')
